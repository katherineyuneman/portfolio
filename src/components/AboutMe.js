        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
              Hi, I'm Katherine Yuneman and I'm a Fullstack Developer.
            </h2>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              I recently graduated from the{" "}
              <a target="_blank" href="https://flatironschool.com/about-us/">
                Flatiron School
              </a>{" "}
              and am experienced in Ruby on Rails and JavaScript based
              programming.
            </p>
          </div>
          ...
          <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 shadow-2xl sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
            <div className="p-8 sm:p-10 lg:flex-auto">
              ...
              <p className="mt-6 text-base leading-7 text-gray-600">
                I have a strong background in Product and Business Analytics. I
                possess strong skills in cross-functional collaboration and
                problem solving that help teams of any size work efficiently. I
                have a passion for tinkering with problems and testing to
                develop functional products from start to finish.
              </p>
