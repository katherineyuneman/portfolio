...
const NavBar = () => {
  ...
  const handleMobileClick = () => {
    console.log("clicked!")
    if (mobileNavBarOpen === false ) {
      setMobileNavBarOpen('display')}
      else {setMobileNavBarOpen(false)}
    }
    ...
    const products = [
      { name: 'Picky Baby', description: 'Get a better understanding of your traffic', href: '#', icon: ChartPieIcon },
      { name: 'Borrow Book Rentals', description: 'Speak directly to your customers', href: '#', icon: CursorArrowRaysIcon },
